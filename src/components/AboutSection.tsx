  ...
  return (
    <section className="py-24 bg-background">
      <div className="container max-w-4xl mx-auto px-4 text-center">
        ...
        <h2 className="cin-reveal cin-delay-1 text-3xl md:text-5xl font-extrabold text-foreground mb-6">
        ...
        <p className="cin-reveal cin-delay-2 text-muted-foreground text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
          A maioria das pessoas entra em um grupo sem estratégia — e paga essa decisão com tempo.
        </p>
        <p className="cin-reveal cin-delay-3 text-muted-foreground text-base md:text-lg mt-4 leading-relaxed max-w-2xl mx-auto">
