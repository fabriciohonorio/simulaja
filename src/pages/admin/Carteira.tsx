    ...
    <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              <div className="space-y-2">
                <h1 className="text-2xl md:text-3xl font-black tracking-tight text-slate-900">
                  Performance da <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Sua Base</span>
                </h1>
              ...
              <div className="grid grid-cols-2 gap-3 w-full md:w-auto">
                <div className="bg-slate-50 border border-slate-100 p-3 rounded-2xl">
                  ...
                  <p className="text-lg font-black text-blue-600">{contemplados} / {total}</p>
                </div>
                <div className="bg-slate-50 border border-slate-100 p-3 rounded-2xl">
        ...
        <div className="lg:col-span-4 grid grid-cols-1 gap-4">
          <div className="relative group overflow-hidden p-4 rounded-[24px] bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-xl shadow-blue-500/20 transition-all hover:scale-[1.02] cursor-default">
             <div className="flex items-center gap-2 opacity-90 mb-2">
                ...
                <p className="text-[10px] font-black uppercase tracking-widest text-white">Controle Financeiro</p>
             </div>
             <p className="text-3xl font-black text-white">{items.filter(i => i.boleto_url).length}</p>
             <p className="text-[10px] bg-white/20 text-white w-fit px-2 py-0.5 rounded-full font-bold mt-2">Boletos Carregados</p>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
        <div className="flex items-center justify-between w-full md:w-auto">
          <h1 className="text-xl sm:text-2xl font-bold">Resumo da Carteira</h1>
