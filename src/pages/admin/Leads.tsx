              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="space-y-8">
                  <section>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <p className="text-sm font-bold">{viewingFichaLead.prazo_meses || getDC(viewingFichaLead.dados_cadastro, ['prazo', 'PRAZO', 'MESES', 'PARCELAS', 'meses'])}</p>
                        </div>
                        <div>
                          <p className="text-[0.9rem] font-bold text-slate-400 uppercase tracking-wider">Segmento</p>
                        <p className="text-sm font-bold uppercase">{viewingFichaLead.tipo_consorcio || getDC(viewingFichaLead.dados_cadastro, ['segmento', 'SEGMENTO', 'TIPO', 'CATEGORIA'])}</p>
                        </div>
                      </div>
                    </div>
                  </section>
                  ...
                  <section>
                    ...
                    <div className="space-y-3">
                       {[
                        { label: "CPF/CNPJ", keys: ["cpf", "CPF", "CNPJ", "cnpj", "CPFCNPJ", "cpf_cnpj"] },
                        { label: "Documento", keys: ["documento", "rg", "cnh", "RG", "CNH", "DOCUMENTO", "DOCUMENTO_NUMERO"] },
                        { label: "Tipo Doc", keys: ["tipoDocumento", "TIPO_DOCUMENTO", "DOC_TIPO", "tipo_documento", "tipo_doc"] },
                        { label: "Emissão", keys: ["dataEmissao", "DATA_EMISSAO", "EMISSAO", "DATAEMISSAO", "data_emissao", "emissao"] },
                        { label: "Órgão/UF", keys: ["orgaoEmissor", "ufOrgaoEmissor", "ORGAO_EMISSOR", "ORGAO_UF", "EMISSOR", "orgao_emissor"] },
                        { label: "Nascimento", keys: ["dataNascimento", "NASCIMENTO", "DATA_NASCIMENTO", "DATANASCIMENTO", "data_nascimento", "nascimento", "birth_date"] },
                        ...
                        { label: "Profissão", keys: ["profissao", "PROFISSAO", "CARGO", "OCUPACAO", "cargo"] },
                        { label: "Renda Mensal", keys: ["renda", "RENDA", "RENDA_MENSAL", "VALOR_RENDA", "renda_mensal"] },
                        { label: "Como Conheceu", keys: ["comunicacao", "COMO_CONHECEU", "ORIGEM", "como_conheceu", "origem"] },
                      ].map((f) => (
                ...
                <div className="space-y-8">
                  <section>
                    ...
                    <div className="space-y-3">
                       {[
                        { label: "Nome da Mãe", keys: ["nomeMae", "MAE_NOME", "NOMEMAE", "NOME_MAE", "mae_nome", "nome_mae"] },
                  ...
                  <section>
                    ...
                    <div className="space-y-3">
                      {[
                        { label: "Empresa", keys: ["nomeEmpresa", "EMPRESA", "LOCAL_TRABALHO", "empresa", "trabalho"] },
                        { label: "Admissão", keys: ["dataAdmissao", "ADMISSAO", "DATA_ADMISSAO", "data_admissao", "admissao"] },
